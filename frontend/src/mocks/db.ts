...
export const mockBookings: Booking[] = [
  {
    ...
    dakshinaAmount: 3100,
    createdAt: new Date(Date.now() - 1.2 * 3600 * 1000).toISOString(), // 1.2 hrs ago (3.8 hrs left)
  },
  {
    id: 'booking-pending-2',
    bookingReference: 'PC-1092',
    ...
    paymentStatus: 'PENDING',
    dakshinaAmount: 3500,
    createdAt: new Date(Date.now() - 2.5 * 3600 * 1000).toISOString(), // 2.5 hrs ago (2.5 hrs left)
  },
  {
    id: 'booking-1',
  ...
  },
  {
    ...
    paymentStatus: 'PENDING',
    dakshinaAmount: 2100,
    cancellationReason: 'Devotee family cancelled appointment after confirmation due to unavoidable travel.',
    cancelledBy: 'USER',
    cancelledAt: '2026-08-22T14:30:00.000Z',
    createdAt: '2026-08-18T00:00:00.000Z',
  },
  {
    id: 'booking-6',
    bookingReference: 'PC-1006',
    userId: 'user-devotee-2',
    priestId: 'priest-1',
    ritualId: 'ritual-1',
    addressId: 'address-1',
    ...
    paymentStatus: 'PENDING',
    dakshinaAmount: 3100,
    cancellationReason: 'Declined by Purohit due to schedule clash with Vedic temple ritual.',
    cancelledBy: 'PRIEST',
