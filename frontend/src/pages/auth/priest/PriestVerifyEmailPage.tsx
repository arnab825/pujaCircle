 ...
 * Standalone Purohit Email Verification Page
...
const PriestVerifyEmailPage: React.FC = () => {
  ...
  const onSubmit = async (data: VerifyOtpInput) => {
    setError(null);
    const res = await authApi.verifyEmailOtp({ email: 'priest@example.demo', otp: data.otp });

    if (res.success) {
      toast.success('Purohit email verified successfully!');
