    ...
    if (clean.length === 6) {
      ...
      try {
        ...
        try {
          ...
          console.warn('Live postal API unavailable, trying local dataset:', fetchErr);
        }
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-3">
        ...
        <p className="text-xs text-muted-foreground">Loading your Vedic credentials...</p>
      </div>
    );
  }
    ...
    <div className="max-w-4xl space-y-6 pb-16">
        ...
        <div>
          <div className="flex items-center gap-2">
            <Badge variant="outline" className="text-primary border-primary/30 text-[11px]">
              <Sparkles className="h-3 w-3 mr-1 text-primary" /> Purohit Credentials
            </Badge>
          ...
          <p className="text-xs text-muted-foreground">
            Manage your credentials, Vedic lineage, languages, service localities, and puja offerings.
          </p>
        </div>
        ...
        <Card className="border-border/80 shadow-xs">
          <CardHeader className="pb-3 border-b">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base font-serif">Basic Profile & Experience</CardTitle>
            </div>
          ...
          <CardContent className="p-4 sm:p-5 space-y-4 text-xs">
            ...
            <div className="space-y-1.5 pt-1">
              <div className="flex items-center justify-between">
                <label className="font-semibold text-foreground">6-Digit PIN Code *</label>
                {isSearchingPin && (
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <span className="font-medium text-muted-foreground text-[11px]">Detected City</span>
                <div className="p-2 rounded-md bg-muted/50 border text-foreground font-medium text-xs">
                  {city || 'Enter PIN Code'}
                </div>
              </div>
              <div className="space-y-1">
                <span className="font-medium text-muted-foreground text-[11px]">Detected State</span>
                <div className="p-2 rounded-md bg-muted/50 border text-foreground font-medium text-xs">
        ...
        <Card className="border-border/80 shadow-xs">
          <CardHeader className="pb-3 border-b">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base font-serif">Verified Contact Channels</CardTitle>
            </div>
            <CardDescription className="text-xs">
            ...
            <div className="p-3.5 rounded-xl bg-muted/40 border space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-semibold text-muted-foreground flex items-center gap-1.5">
                  <Phone className="w-3.5 h-3.5 text-primary" /> Registered Mobile
                </span>
                <Badge variant="outline" className="text-emerald-700 bg-emerald-500/10 border-emerald-500/30 text-[10px] gap-1">
      ...
      <Card className="border-border/80 shadow-xs">
        <CardHeader className="pb-3 border-b">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-base font-serif">Vedic Lineage & Bio</CardTitle>
          </div>
          <CardDescription className="text-xs">
        ...
        <Card className="border-border/80 shadow-xs">
          <CardHeader className="pb-3 border-b">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base font-serif">Languages Spoken ({languages.length})</CardTitle>
            </div>
            <CardDescription className="text-xs">
          ...
          <CardContent className="p-4 sm:p-5 space-y-4 text-xs">
            ...
            <form onSubmit={handleAddCustomLanguage} className="flex gap-2 pt-2 border-t border-border/60">
              <Input
      ...
      <Card className="border-border/80 shadow-xs">
        <CardHeader className="pb-3 border-b">
          <div className="flex items-center gap-2">
            <MapPin className="w-4 h-4 text-primary" />
            <CardTitle className="text-base font-serif">Service Localities & Neighborhoods ({serviceAreas.length})</CardTitle>
          </div>
          <CardDescription className="text-xs">
        ...
        <CardContent className="p-4 sm:p-5 space-y-4 text-xs">
          ...
          <form onSubmit={handleAddArea} className="flex gap-2 pt-2 border-t border-border/60 max-w-md">
            <Input
